...
class Plotter(object):
    ...
    def plot_loop(self):
        ...
        if j[0] == self.sensor and self.acc == True:
            ...
            while True:
                click, data = self.get_serial_data(ser)
    ...
    def plot_gyro_data(self, x, s_x, s_y, s_z, line1, line2, line3, pause_time=0.03):
        """
        docstring
        """
        if line1 == []:
    ...
    def plot_acc_data(self, x, s_x, s_y, s_z, line1, line2, line3, pause_time=0.03):
        if line1 == []:
    ...
    def plot_acc_lin_data(self, x, s_x, s_y, line1, line2, pause_time=0.03):
        if line1 == []:
            plt.ion()
            fig = plt.figure(figsize=(13,6))
            ax = fig.add_subplot(111)
